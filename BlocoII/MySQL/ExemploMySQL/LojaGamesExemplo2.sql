...
SELECT * FROM tb_produtos INNER JOIN tb_categorias on tb_produtos.categoria_id = tb_categorias.id WHERE tb_produtos.categoria_id = 3 ORDER BY nome;

SELECT * FROM tb_produtos INNER JOIN tb_usuarios on tb_produtos.usuario_id = tb_usuarios.id;

SELECT * FROM tb_produtos INNER JOIN tb_categorias on tb_produtos.categoria_id = tb_categorias.id INNER JOIN tb_usuarios on tb_produtos.usuario_id = tb_usuarios.id;
